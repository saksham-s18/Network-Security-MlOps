...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """Read data from MongoDB collection and export as pandas dataframe"""
        try:
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info(f"Exported train and test file at {self.data_ingestion_config.training_file_path} and {self.data_ingestion_config.testing_file_path}")
